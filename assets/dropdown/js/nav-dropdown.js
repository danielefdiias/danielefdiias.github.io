var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function(b, g, d) { b instanceof String && (b = String(b)); for (var k = b.length, h = 0; h < k; h++) { var f = b[h]; if (g.call(d, f, h, b)) return { i: h, v: f } } return { i: -1, v: void 0 } };
$jscomp.ASSUME_ES5 = !1;
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, g, d) { b != Array.prototype && b != Object.prototype && (b[g] = d.value) };
...
(function(b) {
    var g = b.fn.navDropdown,
        d = { ESC: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40 },
        k = { XS: 544, SM: 768, MD: 992, LG: 1200, XL: Infinity },
        h = function() {
            function a(a, e) {
                "length" in a || (a = [a]);
                this.props = {};
            ...
            a.prototype.eq = function(b) { return new a(this[b] ? this[b] : [], this) };
            ...
            a.prototype.parents = function(c) {
                var e = b(this).map(function() { return (new a(this)).is(":toggle") ? this.parentNode : this }).parentsUntil(".nav-dropdown", ".dropdown");
                ":upper" === c && (e = e.last());
            ...
            a.prototype.children = function(c) {
                ...
                b(this).each(function() {
                    ...
                    (c ? f.find("a") : d.is(":root") ? f.find(">li>a") : f.find(">a, >.dropdown>a")).each(function() { c && !this.offsetWidth && !this.offsetHeight || this.disabled || b(this).is("[data-button]") || b(this).hasClass("disabled") || ~b.inArray(this, e) || e.push(this) })
                });
                return new a(e, this)
            };
            a.prototype.root = function() { return new a(b(this).closest(".nav-dropdown"), this) };
            ...
            a.prototype.next = function() { return this.jump("next") };
            a.prototype.prev = function() { return this.jump("prev") };
            a.prototype.first = function() { return this.jump("first") };
            a.prototype.last = function() { return this.jump("last") };
            a.prototype.prop = function(a, e) { return arguments.length ? 1 < arguments.length ? (this.props[a] = e, this) : "object" == typeof arguments[0] ? (b.extend(this.props, arguments[0]), this) : a in this.props ? this.props[a] : null : b.extend({}, this.props) };
            a.prototype.removeProp = function(a) { delete this.props[a]; return this };
            ...
            a.prototype.open = function() { this.is(":closed") && this.click(); return this };
            a.prototype.close = function() { this.is(":opened") && this.click(); return this };
            a.prototype.focus = function() { this.length && this[0].focus(); return this };
            a.prototype.click = function() { this.length && b(this[0]).trigger("click"); return this };
    ...
    f._clearMenus =
        function(a) {
            ...
            if (3 !== a.which) {
                ...
                if (a.target) {
                    if (this === document)
                        if (b(a.target).is("a:not([disabled], .disabled)")) var d = b.Event("collapse.bs.nav-dropdown", { relatedTarget: a.target });
                        else { var g = a.targetWrapper && b(a.targetWrapper).find(".nav-dropdown") || b(a.target).closest(".nav-dropdown"); if (f._isCollapsed(g)) return }
    ...
    b.fn.navDropdown.noConflict = function() { b.fn.navDropdown = g; return this };
    ...
    b(document).on("keydown.bs.nav-dropdown.data-api", ".nav-dropdown", f._dataApiKeydownHandler).on("collapse.bs.navbar-dropdown", f._clearMenus).on("click.bs.nav-dropdown.data-api",
        f._clearMenus).on("click.bs.nav-dropdown.data-api", '[data-toggle="dropdown-submenu"]', f.prototype.toggle).on("click.bs.nav-dropdown.data-api", ".dropdown form", function(a) { a.stopPropagation() });
