var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function(a, h, g) { a instanceof String && (a = String(a)); for (var l = a.length, e = 0; e < l; e++) { var q = a[e]; if (h.call(g, q, e, a)) return { i: e, v: q } } return { i: -1, v: void 0 } };
$jscomp.ASSUME_ES5 = !1;
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, h, g) { a != Array.prototype && a != Object.prototype && (a[h] = g.value) };
...
$jscomp.polyfill = function(a, h, g, l) {
    if (h) {
        g = $jscomp.global;
        a = a.split(".");
        ...
        l = g[a];
        h = h(l);
        h != l && null != h && $jscomp.defineProperty(g, a, { configurable: !0, writable: !0, value: h })
    }
};
...
(function(a) {
    ...
    function l(b) {
        0 !== a(b).find(".nav-tabs").length && a(b).outerFind('section[id^="tabs"]').each(function() {
            ...
            f.each(function() { a(this).attr("id", b + "_tab" + a(this).index()) });
    ...
    a.extend(a.easing, {
        easeInOutCubic: function(a, c, d, f, e) {
            return 1 > (c /= e / 2) ? f / 2 * c * c * c + d : f / 2 * ((c -= 2) *
                c * c + 2) + d
        }
    });
    ...
    a.fn.footerReveal = function() {
        function b() {
            !e && c.outerHeight() <= f.outerHeight() ? (c.css({ "z-index": -999, position: "fixed", bottom: 0 }), c.css({ width: d.outerWidth() }), d.css({ "margin-bottom": c.outerHeight() })) : (c.css({ "z-index": "", position: "", bottom: "" }), c.css({ width: "" }),
                d.css({ "margin-bottom": "" }))
        }
        var c = a(this),
            d = c.prev(),
    ...
    (function(a, c) {
        var b = function(a, b, c) {
            ...
            return function() {
                var f = this,
                    n = arguments;
                d ? clearTimeout(d) : c && a.apply(f, n);
    ...
    a(function() {
        ...
        a(window).scroll(function() {
            ...
            if (k) {
                ...
                c ? d != k.fixed && (h ? (k.fixed = d, a(k.elm).toggleClass("is-fixed")) : m = setTimeout(function() {
                    k.fixed = d;
    ...
    if (!e) {
        if (a.fn.socialLikes) a(document).on("add.cards", function(b) { a(b.target).outerFind(".mbr-social-likes").on("counter.social-likes", function(b, d, f) { 999 < f && a(".social-likes__counter", b.target).html(Math.floor(f / 1E3) + "k") }).socialLikes({ initHtml: !1 }) });
        a(document).on("add.cards", function(b) { a(b.target).hasClass("mbr-reveal") && a(b.target).footerReveal() });
            ...
            if (!a.isMobile() &&
                ...
                f.on("scroll resize", function() {
                    var f = document.documentElement.scrollTop || document.body.scrollTop,
                        e = f + window.innerHeight - 100;
                    a.each(d, function() {
                        var d = a(this),
                            g = d[0],
                            h = g.offsetHeight;
                        g = c(g);
                        if ((g + h >= f && g <= e || b(d)) && d.hasClass("hidden")) d.removeClass("hidden").addClass("animate__fadeInUp animate__delay-1s").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { d.removeClass("animate__animated animate__delay-1s animate__fadeInUp") })
                    })
                });
                f.trigger("scroll")
            }
        });
        a(".nav-dropdown").length && a(".nav-dropdown").swipe({ swipeLeft: function(b, c, d, f, e) { a(".navbar-close").click() } })
    }
    a(document).ready(function() {
    ...
    if (a("nav.navbar").length) {
        ...
        a(".mbr-after-navbar.mbr-fullscreen").css("padding-top", p + "px")
    }
        ...
        if (!e) {
            var b = function(b) {
                var c = a(b).parents("section").find("iframe")[0],
                    f = a(c).attr("src");
                b.parents("section").css("z-index", "5000"); - 1 !== f.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
                ...
                a(b).parents("section").find(a(b).attr("data-modal")).css("display", "table").click(function() {
                    -1 !== f.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',
                        "*"); - 1 !== f.indexOf("vimeo") && e.pause();
    ...
    })), "undefined" === typeof window.initTabsPlugin && (window.initTabsPlugin = !0, l(document.body)), 0 != a(".mbr-slider.carousel").length && a(".mbr-slider.carousel").each(function() {
        var b = a(this),
    ...
    if (e) a(document).on("add.cards", function(b) {
        a(b.target).find(".form-with-styler").length && (b = a(b.target).find(".form-with-styler"), a(b).find('select:not("[multiple]")').each(function() { a(this).styler() }),
        ...
        }), a(this).find("input[type=time]").each(function() { a(this).datetimepicker({ format: "H:i", datepicker: !1 }) }))
    });
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">Mobirise Web Software</a> Mobirise v5.0.25';
